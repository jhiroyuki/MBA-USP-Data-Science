...
load(file = "datasets/tempodist.rdata")
...
load(file = "datasets/paises.RData")
...
load(file = "datasets/corrupcao.RData")
...
load(file = "datasets/bebes.RData")
...
load(file = "datasets/empresas.RData")
...
load(file = "datasets/saeb_rend.RData")
...
load(file = "datasets/planosaude.RData")
